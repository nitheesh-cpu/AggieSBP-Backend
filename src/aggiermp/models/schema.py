...
class Review(BaseModel):
    ...
    would_take_again: Optional[int] = Field(alias="wouldTakeAgain")  # "Yes", "No", or null
    ...
    rating_tags: Optional[List[str]] = Field(alias="ratingTags")  # Will store as list of strings
