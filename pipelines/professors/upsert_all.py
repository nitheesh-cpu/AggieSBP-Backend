...
from pipelines.professors.upsert_reviews_and_summaries import upsert_reviews_and_summaries
...
def main():
    ...
    parser.add_argument("--max-workers", type=int, default=10, help="Number of parallel workers for review fetching")
    parser.add_argument("--batch-size", type=int, default=50, help="Batch size for processing professors")
    ...
    print(f"Configuration: max_workers={args.max_workers}, batch_size={args.batch_size}")
